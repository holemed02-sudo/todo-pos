...
class SettingsFrame(ttk.Frame):
    def __init__(self,master,app):
        ...
        ttk.Button(f,text=self.tr('Enregistrer','حفظ'),command=self.save).grid(row=7,column=0,pady=8)
        ...
        ttk.Button(p,text=self.tr('Enregistrer impression','حفظ إعدادات الطباعة'),command=self.save).grid(row=4,column=2)

...
class SaleFrame(ttk.Frame):
    def __init__(self,master,app):
        ...
        body.columnconfigure(1,weight=6,minsize=500)
        body.columnconfigure(2,weight=2,minsize=220)
        body.rowconfigure(0,weight=1)

        ticket_col=ttk.Frame(body,style='Card.TFrame',padding=12)
        ticket_col.grid(row=0,column=0,sticky='nsew',padx=(0,8))
        catalog_col=ttk.Frame(body,padding=(0,0,8,0))
        ...
        self.quantity_entry.pack(in_=qty_box,fill='x',ipady=5)

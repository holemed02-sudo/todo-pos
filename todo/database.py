...
def migrate(conn):
    ...
    additions = {
        ...
        'held_sales': {'discount_cents': 'INTEGER NOT NULL DEFAULT 0', 'client_id': 'INTEGER REFERENCES clients(id)', 'seller_id': 'INTEGER REFERENCES sellers(id)', 'price_grid_id': 'INTEGER REFERENCES price_grids(id)'},
